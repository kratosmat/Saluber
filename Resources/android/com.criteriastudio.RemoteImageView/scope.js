...
exports.TI_DARK_INDICATOR = Ti.UI.ActivityIndicatorStyle.DARK;
...
exports.downloadImage = function(args) {
    ...
    client.onload = function() {
        ...
        if (200 == client.status) {
            ...
            imageView.image = exports.resizeWidth({
                blob: file.read(),
                width: exports.DISPLAY_WIDTH
            });
            container.image = file.getNativePath();
